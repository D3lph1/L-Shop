    ...
    <div id="content-container">
        ...
        <div class="card card-block">
            ...
            <p class="card-text">
                ...
                <p>
                    Далее вы встретите такие термины, как аргумент команды и опция аргументы прописываются в команду через пробелы.
            ...
            <p class="card-text">
                ...
                <p>
                    ...
                    и выдаст пользователю все, что храниться в платеже. Это могут быть товары, а может быть,
