...
@section('title')
    @lang('content.admin.servers.edit.title', ['name' => $server->name])
@endsection

@section('content')
    <div id="content-container">
        <div class="content-header text-center z-depth-1">
            <h1><i class="fa fa-server fa-left-big"></i>@lang('content.admin.servers.edit.title', ['name' => $server->name])</h1>
        </div>
                ...
                <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1 col-12 offset-xs-0">
                    <div class="row">
                                ...
                                @foreach($categories as $category)
                                    <div class="s-set-category">
                                        <div class="md-form">
                                            ...
                                            <label for="cat{{ $category->id }}">@lang('content.admin.servers.add.categories.name')</label>
                                        </div>
                        ...
                        <div class="col-sm-6 offset-sm-3 col-12 save-and-del text-center">
                            ...
                            <a href="{{ route('admin.servers.remove', ['server' => $currentServer->id, 'remove' => $server->id]) }}" class="btn danger-color"><i class="fa fa-times fa-left"></i>@lang('content.admin.servers.edit.remove')</a>
                        </div>
                    </div>
                </div>
            </div>
