...
@section('content')
    ...
    <div class="full-h flex-center pd-v-form">
        <div class="card no-pdh z-depth-4 col-xl-4 col-md-6 col-11">
            ...
            <div class="card-block" id="sign-up" data-url="{{ route('signup') }}" data-redirect="{{ route('servers') }}">
                ...
                <div class="md-form">
                    ...
                    <input type="text" id="su-email" class="form-control">
                ...
                <div class="md-form">
                    <i class="fa fa-unlock-alt fa-lg prefix"></i>
                    <input type="password" id="su-password-confirm" class="form-control">
