    ...
    'admin' => [
        'control' => [
            'basic' => [
                ...
                'shop_section' => 'Магазин',
                'sort_products' => [
                    'title' => 'Сортировать товары в катлоге по',
                    'by_name' => 'Названию предмета (А -> Я)',
                    'by_name_desc' => 'Названию предмета (Я -> А)',
                    'by_priority' => 'Приоритету сортировки (1 -> N)',
                    'by_priority_desc' => 'Приоритету сортировки (N -> 1)',
                ],
            ],
        ],
        'products' => [
