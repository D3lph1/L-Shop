    ...
    'frontend' => [
        'auth' => [
            'login' => [
                ...
                'frozen_alternative' => 'Аккаунт временно заморожен. Авторизация будет недоступна последующие :delay секунд.',
    ...
    'admin' => [
        ...
        'servers' => [
            'add' => [
                ...
                'category' => [
                    'add' => [
                        'empty' => 'Имя категории не должно быть пустым.',
