        ...
        <v-card-title class="product-price">
            <span class="subheading">
                ...
                <span v-if="isCurrency">
                    {{ $t('content.frontend.shop.catalog.item.stack_currency', {stack}) }}
                </span>
                <span v-if="isRegionOwner">
                    {{ $t('content.frontend.shop.catalog.item.stack_region_owner', {stack}) }}
                </span>
                <span v-if="isRegionMember">
                    {{ $t('content.frontend.shop.catalog.item.stack_region_member', {stack}) }}
                </span>
                <span v-if="isCommand">
                    {{ $t('content.frontend.shop.catalog.item.stack_command', {stack}) }}
                </span>
            </span>
        </v-card-title>
