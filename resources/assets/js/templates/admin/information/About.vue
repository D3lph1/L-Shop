        ...
        <v-layout row wrap align-center justify-center class="mt-5">
            <v-flex xs6 sm4 md4 lg4>
                <v-tooltip bottom>
                    ...
                    <span>{{ $t('content.admin.information.about.version', {version: '5.5.41'}) }}</span>
                </v-tooltip>
            </v-flex>
            <v-flex xs6 sm4 md4 lg4>
                <v-tooltip bottom>
            ...
            <v-flex xs6 sm4 md4 lg4>
                <v-tooltip bottom>
                    ...
                    <span>{{ $t('content.admin.information.about.version', {version: '2.6.2'}) }}</span>
                </v-tooltip>
            </v-flex>
            <v-flex xs6 sm4 md4 lg4>
                <v-tooltip bottom>
                    ...
                    <span>{{ $t('content.admin.information.about.version', {version: '1.0.19'}) }}</span>
                </v-tooltip>
            </v-flex>
        </v-layout>
