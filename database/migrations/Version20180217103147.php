...
class Version20180217103147 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE lshop_items (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, type VARCHAR(32) NOT NULL, image VARCHAR(255) DEFAULT NULL, extra LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE lshop_products (id INT AUTO_INCREMENT NOT NULL, item_id INT DEFAULT NULL, category_id INT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, stack INT NOT NULL, sort_priority DOUBLE PRECISION NOT NULL, INDEX IDX_10E5818D126F525E (item_id), INDEX IDX_10E5818D12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
