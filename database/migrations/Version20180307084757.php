...
class Version20180307084757 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE lshop_enchantments_items DROP FOREIGN KEY FK_CFD5A797F3927CF3');
        $this->addSql('ALTER TABLE lshop_enchantments_items DROP FOREIGN KEY FK_CFD5A797126F525E');
