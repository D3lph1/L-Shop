...
class Version20180724124413 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE lshop_categories (id INT AUTO_INCREMENT NOT NULL, server_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_E58BBDB31844E6B7 (server_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE lshop_distributions (id INT AUTO_INCREMENT NOT NULL, purchase_item_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_A95F2FFC9B59827 (purchase_item_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE lshop_enchantments (id INT AUTO_INCREMENT NOT NULL, game_id INT NOT NULL, max_level SMALLINT NOT NULL, `group` VARCHAR(32) DEFAULT NULL, UNIQUE INDEX UNIQ_A6790267E48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE lshop_items (id INT AUTO_INCREMENT NOT NULL, `name` VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, type VARCHAR(32) NOT NULL, image VARCHAR(255) DEFAULT NULL, signature VARCHAR(255) DEFAULT NULL, extra LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE lshop_pages (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, url VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_35A16242F47645AE (url), INDEX url_idx (url), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE lshop_permissions (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(64) NOT NULL, UNIQUE INDEX UNIQ_3C33BFC85E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE lshop_permission_user (permission_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_2F5D723FFED90CCA (permission_id), INDEX IDX_2F5D723FA76ED395 (user_id), PRIMARY KEY(permission_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE lshop_permission_role (permission_id INT NOT NULL, role_id INT NOT NULL, INDEX IDX_F5A72E1CFED90CCA (permission_id), INDEX IDX_F5A72E1CD60322AC (role_id), PRIMARY KEY(permission_id, role_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE lshop_roles (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(32) NOT NULL, UNIQUE INDEX UNIQ_A3EBA9F05E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE lshop_role_user (role_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_2B38BC71D60322AC (role_id), INDEX IDX_2B38BC71A76ED395 (user_id), PRIMARY KEY(role_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE lshop_shopping_cart (id INT AUTO_INCREMENT NOT NULL, server INT DEFAULT NULL, distribution_id INT DEFAULT NULL, player VARCHAR(255) NOT NULL, type VARCHAR(16) NOT NULL, item VARCHAR(255) DEFAULT NULL, amount INT NOT NULL, extra LONGTEXT DEFAULT NULL, INDEX IDX_5AE0CF805A6DD5F6 (server), UNIQUE INDEX UNIQ_5AE0CF806EB6DDB5 (distribution_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE lshop_throttles (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, ip VARCHAR(255) DEFAULT NULL, until DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_AA4DA5BCA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE lshop_users (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(32) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(60) NOT NULL, balance DOUBLE PRECISION NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', access_token CHAR(36) DEFAULT NULL, server_id VARCHAR(41) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_15622DEF85E0677 (username), UNIQUE INDEX UNIQ_15622DEE7927C74 (email), UNIQUE INDEX UNIQ_15622DED17F50A6 (uuid), INDEX username_idx (username), INDEX email_idx (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE lshop_lp_groups (`name` VARCHAR(36) NOT NULL, PRIMARY KEY(`name`)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE lshop_lp_messages (id INT AUTO_INCREMENT NOT NULL, time DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', msg LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE lshop_lp_players (uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', primary_group VARCHAR(36) DEFAULT NULL, username VARCHAR(32) NOT NULL, INDEX IDX_30AEC934F8D69D18 (primary_group), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE lshop_lp_tracks (name VARCHAR(36) NOT NULL, groups LONGTEXT NOT NULL, PRIMARY KEY(name)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE lshop_categories ADD CONSTRAINT FK_E58BBDB31844E6B7 FOREIGN KEY (server_id) REFERENCES lshop_servers (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE lshop_products ADD CONSTRAINT FK_10E5818D12469DE2 FOREIGN KEY (category_id) REFERENCES lshop_categories (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE lshop_shopping_cart ADD CONSTRAINT FK_5AE0CF806EB6DDB5 FOREIGN KEY (distribution_id) REFERENCES lshop_distributions (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE lshop_throttles ADD CONSTRAINT FK_AA4DA5BCA76ED395 FOREIGN KEY (user_id) REFERENCES lshop_users (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE lshop_throttles DROP FOREIGN KEY FK_AA4DA5BCA76ED395');
        ...
        $this->addSql('DROP TABLE lshop_throttles');
